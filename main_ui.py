...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.resize(1300, 700)  # 기본 창 크기 설정
        ...
        logo_pixmap = logo_pixmap.scaled(120, logo_pixmap.height(), Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        # 중앙 컨텐츠 설정 (Main Content Area에 로고 이미지 추가)
        central_content = QLabel()
        logo_pixmap = QPixmap("./images/main_logo.png")
        logo_pixmap = logo_pixmap.scaled(400, 400, Qt.KeepAspectRatio, Qt.SmoothTransformation)  # 너비 400 기준으로 비율 유지
        central_content.setPixmap(logo_pixmap)
        central_content.setAlignment(Qt.AlignCenter)  # 중앙 정렬
